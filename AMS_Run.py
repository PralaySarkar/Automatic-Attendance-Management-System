...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/pcsar/Desktop/Attendace_Management_System/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\pcsar\Desktop\Attendace_Management_System\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'IIITK' :
            if password == 'iiit@20':
                ...
                cs = 'C:/Users/pcsar/Desktop/Attendace_Management_System/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
